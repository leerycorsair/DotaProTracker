...
type DeleteTournamentTeamBox struct {
	mainWindow            fyne.Window
	tournamentTeamManager managers.TournamentTeamManager
}

func (obj *DeleteTournamentTeamBox) New(mainWindow fyne.Window, managers managers.Managers) *fyne.Container {
	...
	handler := func() {
		err := obj.tournamentTeamManager.Delete(idEntry.Text)
		if err != nil {
